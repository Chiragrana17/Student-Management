...
app.use(express.urlencoded()) ;  // built-in middleware in Express. js
const cors = require("cors") ;
app.use(cors()) ; // connect middleware use to enable cors          
// for frontend-backend connectivity 

require("dotenv").config() ;  //load environment variables
const cookieParser = require("cookie-parser") ; //middlewre attach to client request object
const session = require("express-session"); //stores session data on the server side
